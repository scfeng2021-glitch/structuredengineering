const translations = {
    ...
    it: {
        ...
        intro_title: "Continuità Operativa e Eccellenza Strutturata",
        intro_text: "Structured Engineering trasforma le sfide operative in opportunità di crescita sostenibile, garantendo continuità, affidabilità e eccellenza produttiva.",

        challenges_title: "Sfide Industriali Attuali",
        ch1_title: "Downtime Non Pianificato",
        ch1_text: "Fermi macchina frequenti riducono la produttività e aumentano i costi operativi.",
        ch2_title: "Perdita di Competenze Critiche",
        ch2_text: "Dipendenza da singoli esperti crea vulnerabilità organizzativa.",
        ch3_title: "Margini Erosi",
        ch3_text: "Inefficienze e sprechi riducono la redditività.",
        ch4_title: "Processi Non Standardizzati",
        ch4_text: "Mancanza di procedure strutturate genera variabilità e problemi qualità.",

        vision_title: "La Nostra Visione",
        v1_title: "Continuità Operativa",
        v1_text: "Stabilità e affidabilità nei processi produttivi.",
        v2_title: "Eccellenza Strutturata",
        v2_text: "Processi ottimizzati e standardizzati.",
        v3_title: "Crescita Sostenibile",
        v3_text: "Risultati misurabili e durevoli nel tempo.",

        method_title: "Metodologia Operativa",
        m1_title: "1. Analisi Diagnostica",
        m1_text: "Identificazione colli di bottiglia e opportunità.",
        m2_title: "2. Progettazione Strutturata",
        m2_text: "Soluzioni personalizzate con timeline e deliverables.",
        m3_title: "3. Implementazione",
        m3_text: "Monitoraggio KPI e stabilizzazione dei risultati.",

        services_title: "Servizi Principali",
        s1: "Ottimizzazione Processi",
        s2: "Trasferimento Know‑How",
        s3: "Standardizzazione Operativa",
        s4: "Consulenza Strategica",
        s5: "CAD & 3D Design",
    ...
    en: {
        title: "STRUCTURED ENGINEERING S.R.L.",
        subtitle: "Engineering Structure. Operational Continuity.",
        intro_title: "Operational Continuity & Structured Excellence",
        intro_text: "Structured Engineering transforms operational challenges into sustainable growth opportunities, ensuring continuity, reliability, and world‑class industrial performance.",

        challenges_title: "Current Industrial Challenges",
        ch1_title: "Unplanned Downtime",
        ch1_text: "Frequent machine stops reduce productivity and increase operational costs.",
        ch2_title: "Loss of Critical Expertise",
        ch2_text: "Dependence on single experts creates operational vulnerability.",
        ch3_title: "Eroded Margins",
        ch3_text: "Inefficiencies and waste reduce profitability.",
        ch4_title: "Non‑Standardized Processes",
        ch4_text: "Lack of structured procedures generates variability and quality issues.",

        vision_title: "Our Vision",
        v1_title: "Operational Continuity",
        v1_text: "Stability and reliability across production processes.",
        v2_title: "Structured Excellence",
        v2_text: "Optimized and standardized workflows.",
        v3_title: "Sustainable Growth",
        v3_text: "Measurable and long‑lasting results.",

        method_title: "Operational Methodology",
        m1_title: "1. Diagnostic Analysis",
        m1_text: "Identification of bottlenecks and opportunities.",
        m2_title: "2. Structured Design",
        m2_text: "Tailored solutions with clear timelines and deliverables.",
        m3_title: "3. Implementation",
        m3_text: "KPI monitoring and stabilization of results.",

        services_title: "Core Services",
        s1: "Process Optimization",
        s2: "Knowledge Transfer",
        s3: "Operational Standardization",
        s4: "Strategic Consulting",
        s5: "CAD & 3D Design",
        s6: "Technical Governance",
        s7: "Competency Stabilization",
